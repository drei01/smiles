...
public class MirrorClient {
	...
	public static Mirror getMirror(Credential credential) {
		return new Mirror.Builder(new NetHttpTransport(), new JacksonFactory(), credential).setApplicationName("PG Java Starter").build();
	}
	 ...
	 *            the item to insert
	 */
	public static TimelineItem insertTimelineItem(Credential credential, TimelineItem item) throws IOException {
	 ...
	 */
	public static void insertTimelineItem(Credential credential, TimelineItem item, String attachmentContentType, byte[] attachmentData) throws IOException {
	 ...
	 */
	public static void insertTimelineItem(Credential credential, TimelineItem item, String attachmentContentType, InputStream attachmentInputStream)
			throws IOException {
